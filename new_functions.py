...
async def createThread_DB(thread_id, user_id): # here a dict shoulb be passed instead of two arguments
    ...
    try:
        ...
        created_thread = await threads_repo().create(data={"user_id": user_id, "thread_id": thread_id})
        return {
